...
const bigMap = `{
	...
	"name" : "BFF Big v3 from HaxMaps",

	"width" : 800,

	"height" : 350,

	"bg" : { "type" : "", "kickOffRadius" : 80, "color" : "34414b" },

	"vertexes" : [
		/* 0 */ { "x" : -701.4, "y" : -320, "trait" : "vertexDefault" },
		/* 1 */ { "x" : 701.4, "y" : -320, "trait" : "vertexDefault" },
		/* 2 */ { "x" : 701.4, "y" : 320, "trait" : "vertexDefault" },
		/* 3 */ { "x" : -701.4, "y" : 320, "trait" : "vertexDefault" },
		/* 4 */ { "x" : 0, "y" : 320, "trait" : "vertexDefault" },
		/* 5 */ { "x" : 0, "y" : -320, "trait" : "vertexDefault" },
		...
		/* 8 */ { "x" : -700, "y" : 85, "trait" : "vertexDefault" },
		/* 9 */ { "x" : -700, "y" : -320, "trait" : "vertexDefault" },
		/* 10 */ { "x" : -700, "y" : 320, "trait" : "vertexDefault" },
		/* 11 */ { "x" : -700, "y" : -85, "trait" : "vertexDefault" },
		/* 12 */ { "x" : 700, "y" : -85, "trait" : "vertexDefault" },
		/* 13 */ { "x" : 700, "y" : 85, "trait" : "vertexDefault" },
		/* 14 */ { "x" : 0, "y" : 350, "trait" : "vertexDefault" },
		/* 15 */ { "x" : 0, "y" : -350, "trait" : "vertexDefault" },
		/* 16 */ { "x" : 736.4, "y" : -85, "trait" : "vertexDefault" },
		/* 17 */ { "x" : 736.4, "y" : 85, "trait" : "vertexDefault" },
		/* 18 */ { "x" : -736.4, "y" : -85, "trait" : "vertexDefault" },
		/* 19 */ { "x" : -736.4, "y" : 85, "trait" : "vertexDefault" },
		/* 20 */ { "x" : -360, "y" : -318.5, "trait" : "vertexDefault" },
		/* 21 */ { "x" : -360, "y" : 318.5, "trait" : "vertexDefault" },
		/* 22 */ { "x" : 360, "y" : -318.5, "trait" : "vertexDefault" },
		/* 23 */ { "x" : 360, "y" : 318.5, "trait" : "vertexDefault" },
		/* 24 */ { "x" : 0, "y" : -1.5, "trait" : "vertexDefault" },
		/* 25 */ { "x" : 0, "y" : 1.5, "trait" : "vertexDefault" },
		/* 26 */ { "x" : 698.5, "y" : 125, "trait" : "vertexDefault" },
		/* 27 */ { "x" : 698.5, "y" : -125, "trait" : "vertexDefault" },
		/* 28 */ { "x" : 628.6, "y" : -125, "trait" : "vertexDefault" },
		/* 29 */ { "x" : 628.6, "y" : 125, "trait" : "vertexDefault" },
		/* 30 */ { "x" : 360, "y" : -135, "trait" : "vertexDefault" },
		/* 31 */ { "x" : 360, "y" : 135, "trait" : "vertexDefault" },
		/* 32 */ { "x" : -360, "y" : -135, "trait" : "vertexDefault" },
		/* 33 */ { "x" : -360, "y" : 135, "trait" : "vertexDefault" },
		/* 34 */ { "x" : -698.5, "y" : 125, "trait" : "vertexDefault" },
		/* 35 */ { "x" : -628.4, "y" : 125, "trait" : "vertexDefault" },
		/* 36 */ { "x" : -628.6, "y" : -125, "trait" : "vertexDefault" },
		/* 37 */ { "x" : -698.5, "y" : -125, "trait" : "vertexDefault" },
		/* 38 */ { "x" : -500, "y" : 1.5, "trait" : "vertexDefault" },
		/* 39 */ { "x" : -500, "y" : -1.5, "trait" : "vertexDefault" },
		/* 40 */ { "x" : 500, "y" : 1.5, "trait" : "vertexDefault" },
		/* 41 */ { "x" : 500, "y" : -1.5, "trait" : "vertexDefault" },
		/* 42 */ { "x" : -702.5, "y" : -85, "trait" : "vertexDefault" },
		/* 43 */ { "x" : -705, "y" : -85, "trait" : "vertexDefault" },
		/* 44 */ { "x" : -707.5, "y" : -85, "trait" : "vertexDefault" },
		/* 45 */ { "x" : -710, "y" : -85, "trait" : "vertexDefault" },
		/* 46 */ { "x" : -712.5, "y" : -85, "trait" : "vertexDefault" },
		/* 47 */ { "x" : -715, "y" : -85, "trait" : "vertexDefault" },
		/* 48 */ { "x" : -717.5, "y" : -85, "trait" : "vertexDefault" },
		/* 49 */ { "x" : -720, "y" : -85, "trait" : "vertexDefault" },
		/* 50 */ { "x" : -722.5, "y" : -85, "trait" : "vertexDefault" },
		/* 51 */ { "x" : -725, "y" : -85, "trait" : "vertexDefault" },
		/* 52 */ { "x" : -727.5, "y" : -85, "trait" : "vertexDefault" },
		/* 53 */ { "x" : -730, "y" : -85, "trait" : "vertexDefault" },
		/* 54 */ { "x" : -732.5, "y" : -85, "trait" : "vertexDefault" },
		/* 55 */ { "x" : -735, "y" : -85, "trait" : "vertexDefault" },
		/* 56 */ { "x" : -702.5, "y" : 85, "trait" : "vertexDefault" },
		/* 57 */ { "x" : -705, "y" : 85, "trait" : "vertexDefault" },
		/* 58 */ { "x" : -707.5, "y" : 85, "trait" : "vertexDefault" },
		/* 59 */ { "x" : -710, "y" : 85, "trait" : "vertexDefault" },
		/* 60 */ { "x" : -712.5, "y" : 85, "trait" : "vertexDefault" },
		/* 61 */ { "x" : -715, "y" : 85, "trait" : "vertexDefault" },
		/* 62 */ { "x" : -717.5, "y" : 85, "trait" : "vertexDefault" },
		/* 63 */ { "x" : -720, "y" : 85, "trait" : "vertexDefault" },
		/* 64 */ { "x" : -722.5, "y" : 85, "trait" : "vertexDefault" },
		/* 65 */ { "x" : -725, "y" : 85, "trait" : "vertexDefault" },
		/* 66 */ { "x" : -727.5, "y" : 85, "trait" : "vertexDefault" },
		/* 67 */ { "x" : -730, "y" : 85, "trait" : "vertexDefault" },
		/* 68 */ { "x" : -732.5, "y" : 85, "trait" : "vertexDefault" },
		/* 69 */ { "x" : -735, "y" : 85, "trait" : "vertexDefault" },
		/* 70 */ { "x" : 702.5, "y" : 85, "trait" : "vertexDefault" },
		/* 71 */ { "x" : 705, "y" : 85, "trait" : "vertexDefault" },
		/* 72 */ { "x" : 707.5, "y" : 85, "trait" : "vertexDefault" },
		/* 73 */ { "x" : 710, "y" : 85, "trait" : "vertexDefault" },
		/* 74 */ { "x" : 712.5, "y" : 85, "trait" : "vertexDefault" },
		/* 75 */ { "x" : 715, "y" : 85, "trait" : "vertexDefault" },
		/* 76 */ { "x" : 717.5, "y" : 85, "trait" : "vertexDefault" },
		/* 77 */ { "x" : 720, "y" : 85, "trait" : "vertexDefault" },
		/* 78 */ { "x" : 722.5, "y" : 85, "trait" : "vertexDefault" },
		/* 79 */ { "x" : 725, "y" : 85, "trait" : "vertexDefault" },
		/* 80 */ { "x" : 727.5, "y" : 85, "trait" : "vertexDefault" },
		/* 81 */ { "x" : 730, "y" : 85, "trait" : "vertexDefault" },
		/* 82 */ { "x" : 732.5, "y" : 85, "trait" : "vertexDefault" },
		/* 83 */ { "x" : 735, "y" : 85, "trait" : "vertexDefault" },
		/* 84 */ { "x" : 702.5, "y" : -85, "trait" : "vertexDefault" },
		/* 85 */ { "x" : 705, "y" : -85, "trait" : "vertexDefault" },
		/* 86 */ { "x" : 707.5, "y" : -85, "trait" : "vertexDefault" },
		/* 87 */ { "x" : 710, "y" : -85, "trait" : "vertexDefault" },
		/* 88 */ { "x" : 712.5, "y" : -85, "trait" : "vertexDefault" },
		/* 89 */ { "x" : 715, "y" : -85, "trait" : "vertexDefault" },
		/* 90 */ { "x" : 717.5, "y" : -85, "trait" : "vertexDefault" },
		/* 91 */ { "x" : 720, "y" : -85, "trait" : "vertexDefault" },
		/* 92 */ { "x" : 722.5, "y" : -85, "trait" : "vertexDefault" },
		/* 93 */ { "x" : 725, "y" : -85, "trait" : "vertexDefault" },
		/* 94 */ { "x" : 727.5, "y" : -85, "trait" : "vertexDefault" },
		/* 95 */ { "x" : 730, "y" : -85, "trait" : "vertexDefault" },
		/* 96 */ { "x" : 732.5, "y" : -85, "trait" : "vertexDefault" },
		/* 97 */ { "x" : 735, "y" : -85, "trait" : "vertexDefault" },
		/* 98 */ { "x" : -700, "y" : -321.4, "trait" : "vertexDefault" },
		/* 99 */ { "x" : 700, "y" : -321.4, "trait" : "vertexDefault" },
		/* 100 */ { "x" : 700, "y" : 321.4, "trait" : "vertexDefault" },
		/* 101 */ { "x" : -700, "y" : 321.4, "trait" : "vertexDefault" },
		/* 102 */ { "x" : -630, "y" : -126.4, "trait" : "vertexDefault" },
		/* 103 */ { "x" : -630, "y" : 126.4, "trait" : "vertexDefault" },
		/* 104 */ { "x" : 630, "y" : -126.4, "trait" : "vertexDefault" },
		/* 105 */ { "x" : 630, "y" : 126.4, "trait" : "vertexDefault" },
		/* 106 */ { "x" : 735, "y" : -86.4, "trait" : "vertexDefault" },
		/* 107 */ { "x" : 735, "y" : 86.4, "trait" : "vertexDefault" },
		/* 108 */ { "x" : -735, "y" : -86.4, "trait" : "vertexDefault" },
		/* 109 */ { "x" : -735, "y" : 86.4, "trait" : "vertexDefault" }

	],

	"segments" : [
		{ "v0" : 0, "v1" : 1, "trait" : "wall_map" },
		{ "v0" : 99, "v1" : 12, "trait" : "wall_map" },
		{ "v0" : 13, "v1" : 100, "trait" : "wall_map" },
		{ "v0" : 2, "v1" : 3, "trait" : "wall_map" },
		{ "v0" : 101, "v1" : 8, "trait" : "wall_map" },
		
		{ "v0" : 5, "v1" : 6, "trait" : "wall_map_nc" },
		{ "v0" : 4, "v1" : 7, "trait" : "wall_map_nc" },
		
		{ "v0" : 11, "v1" : 98, "trait" : "wall_map" },
		
		{ "v0" : 6, "v1" : 15, "trait" : "KO_barrier" },
		{ "v0" : 7, "v1" : 14, "trait" : "KO_barrier" },
		
		{ "v0" : 6, "v1" : 7, "curve" : 180, "trait" : "KO_wall_red" },
		
		{ "v0" : 7, "v1" : 6, "curve" : 180, "trait" : "KO_wall_blue" },
		
		{ "v0" : 21, "v1" : 20, "trait" : "decoration_map" },
		{ "v0" : 23, "v1" : 22, "trait" : "decoration_map" },
		{ "v0" : 24, "v1" : 25, "curve" : 180, "trait" : "decoration_map" },
		{ "v0" : 25, "v1" : 24, "curve" : 180, "trait" : "decoration_map" },
		{ "v0" : 27, "v1" : 28, "trait" : "decoration_map" },
		{ "v0" : 29, "v1" : 26, "trait" : "decoration_map" },
		{ "v0" : 31, "v1" : 30, "curve" : 90, "trait" : "decoration_map" },
		{ "v0" : 32, "v1" : 33, "curve" : 90, "trait" : "decoration_map" },
		{ "v0" : 34, "v1" : 35, "trait" : "decoration_map" },
		{ "v0" : 37, "v1" : 36, "trait" : "decoration_map" },
		
		{ "v0" : 39, "v1" : 38, "trait" : "map_point" },
		{ "v0" : 38, "v1" : 39, "trait" : "map_point" },
		{ "v0" : 41, "v1" : 40, "trait" : "map_point" },
		{ "v0" : 40, "v1" : 41, "trait" : "map_point" },
		
		{ "v0" : 12, "v1" : 16, "trait" : "wall_blue_goal" },
		{ "v0" : 106, "v1" : 107, "trait" : "wall_blue_goal" },
		{ "v0" : 17, "v1" : 13, "trait" : "wall_blue_goal" },
		
		{ "v0" : 8, "v1" : 19, "trait" : "wall_red_goal" },
		{ "v0" : 109, "v1" : 108, "trait" : "wall_red_goal" },
		{ "v0" : 18, "v1" : 11, "trait" : "wall_red_goal" },
		
		{ "v0" : 11, "v1" : 8, "trait" : "goal_line" },
		{ "v0" : 12, "v1" : 13, "trait" : "goal_line" },
		
		{ "v0" : 102, "v1" : 103, "trait" : "decoration_map" },
		{ "v0" : 105, "v1" : 104, "trait" : "decoration_map" }
	...
	"goals" : [
		{ "p0" : [-707.8,85 ], "p1" : [-707.8,-85 ], "team" : "red" },
		{ "p0" : [707.8,85 ], "p1" : [707.8,-85 ], "team" : "blue" }

	],

	"discs" : [
		{ "pos" : [-700,-85 ], "trait" : "goal_post" },
		{ "pos" : [-700,85 ], "trait" : "goal_post" },
		{ "pos" : [700,-85 ], "trait" : "goal_post" },
		{ "pos" : [700,85 ], "trait" : "goal_post" }
	...
	"traits" : {
		...
		"wall_map" : { "vis" : true, "color" : "151a1e", "bCoef" : 1, "cMask" : ["ball" ], "bias" : -10 },
		"wall_map_nc" : { "vis" : true, "color" : "151a1e", "bCoef" : 0, "cMask" : [ ], "cGroup" : [ ] },
		...
		"KO_wall_red" : { "vis" : true, "color" : "ce8a4a", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO" ] },
		"KO_wall_blue" : { "vis" : true, "color" : "ce8a4a", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["blueKO" ] }
